...
public sealed class CompleteOnboardingHandler : IRequestHandler<CompleteOnboardingCommand>
{
    ...
    public async Task Handle(CompleteOnboardingCommand request, CancellationToken ct)
    {
